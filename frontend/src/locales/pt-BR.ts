export default {
    ...
    config: {
        ...
        help: 'Ajuda',
        generalHelp: 'Às vezes pode acontecer de um arquivo estar corrompido, mas ainda ser reproduzível. Isso pode causar um erro de streaming para todos os arquivos seguintes. A única solução nesse caso é parar o ecast e reiniciá-lo.',
        stopThreshold: 'O limite para o ecast se ele estiver fora de sincronia acima deste valor. Um número abaixo de 3 pode causar erros inesperados.',
        ...
        outputHelp: `A codificação final do playout, ajuste as configurações de acordo com suas necessidades. Use o modo 'stream' e ajuste o 'Parâmetro de Saída' quando quiser fazer streaming para um servidor RTMP/RTSP/SRT/... No ambiente de produção, não sirva playlists HLS com ecast; use Nginx ou outro servidor web!`,
        outputParam: 'Os caminhos dos segmentos e playlists HLS são relativos.',
        restartTile: 'Reiniciar Playout',
        restartText: 'Reiniciar o ecast para aplicar as alterações?',
        ...
        sharedStorage: 'O ecast é executado dentro de um contêiner; use a mesma raiz de armazenamento para todos os canais!',
        timezone: 'Timezone',
    },
    user: {
