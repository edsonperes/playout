export default {
    ...
    config: {
        ...
        help: 'Hilfe',
        generalHelp: 'Manchmal kann es passieren, dass eine Datei beschädigt ist, aber dennoch abgespielt werden kann. Dies kann zu einem Streaming-Fehler für alle folgenden Dateien führen. Die einzige Lösung in diesem Fall ist, ecast zu stoppen und erneut zu starten.',
        stopThreshold: 'Der Schwellenwert stoppt ecast, wenn es zeitlich asynchron über diesem Wert ist. Eine Zahl unter 3 kann unerwartete Fehler verursachen.',
        ...
        outputHelp: `Die endgültige Playout-Codierung, passe die Einstellungen nach deinen Bedürfnissen an. Verwende den 'stream'-Modus und passe den 'Ausgabe-Parameter' an, wenn du zu einem RTMP/RTSP/SRT/...-Server streamen möchtest. Im Produktionsbetrieb verwende kein HLS mit ecast; nutze Nginx oder einen anderen Webserver!`,
        outputParam: 'HLS-Segment- und Playlist-Pfade sind relativ.',
        restartTile: 'Playout neustarten',
        restartText: 'ecast neustarten um Einstellungen anzuwenden?',
        ...
        sharedStorage: 'ecast läuft innerhalb eines Containers, verwenden Sie den gleichen Speicherstamm für alle Kanäle!',
        timezone: 'Zeitzone',
    },
    user: {
